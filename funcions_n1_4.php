<?php
/*
Per jugar a el "amagatall" se'ns ha demanat un programa que compti fins a 10. Però la persona que 
comptarà és una mica tramposa i ho farà comptant de dos en dos. 
...
*/
    ...
    function comptaFinsFinalde2en2 ($finalDelCompte=10) {
    ...
    echo "<h3>Crea una funció que compti fins a num donat (ex: ".$numDonat."), de 2 en 2, 
    mostrant cada número del compte per pantalla.</h3>";

    comptaFinsFinalde2en2($numDonat);

    echo "<h3>Si no envies cap num en la crida comptarà fins 10, de 2 en 2, 
    mostrant cada número del compte per pantalla.</h3>";

    comptaFinsFinalde2en2();
